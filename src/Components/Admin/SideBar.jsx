...
import {
  FaLock, // Strongbox alternative
  FaUserPlus, // UserCirlceAdd alternative
  FaCog, // Setting2 alternative
} from "react-icons/fa";
const SideBar = () => {
        ...
        <div className="p-5">
            ...
            <div className="">
              <div className="flex flex-row justify-between ">
                <div className="flex flex-row space-x-2 text-md">
                  <FaLock size="28" color="#313033" variant="Bold" />
          ...
          <div className=" mt-10">
            <div className="">
              <div className="flex flex-row justify-between ">
                <div className="flex flex-row space-x-2 text-md">
                  <FaUserPlus size="28" color="#313033" variant="Bold" />
          ...
          <div className=" mt-60">
            <div className="">
              <div className="flex flex-row justify-between ">
                <div className="flex flex-row space-x-2 text-md">
                  <FaCog size="28" color="#313033" variant="Bold" />
                  <p>Settings</p>
                </div>
                {/* <ArrowDown2 onClick={() => setCourseMenu(!coursemenu)} size="22" color="#313033" /> */}
              </div>
