  ...
  return (
    <>
      <div className="flex items-center  space-x-5 flex-row">
        <FaArrowLeft onClick={() => mutateState(1)} size="32" color="#000000" />
        <h1>Post New Job</h1>
      </div>
      ...
      <div className="flex flex-row space-x-10  mt-5">
        <div>
          ...
          <input
            ...
            className="h-[50px] p-2 rounded-md w-[478px] border-2"
          />
        </div>
        <div>
      ...
      <div className="flex flex-row space-x-10  mt-5">
          ...
          {[
            ...
            <div className="flex space-x-2 w-[478px]">
              <input
                ...
                className="w-6 border-purple-950  text-purple-500 focus:ring-purple-500 mt-5 h-6"
                type="radio"
                value={x.type}
                name="job"
              />
              <label className="mt-5">{x.type}</label>
              <br />
            </div>
          ))}
        </div>
        <div className="flex flex-col">
          ...
          <input
            ...
            value={company_name}
            type="text"
            className="h-[50px] rounded-md w-[478px] p-2 border-2"
          ...
          <input
            ...
            value={technology}
            type="text"
            className="h-[50px] mt-5 rounded-md w-[478px] p-2 border-2"
            placeholder="Technology (please use '.' after a point)"
          />
          <input
            type="text"
            onChange={(e) => setLocation(e.target.value)}
            value={location}
            className="h-[50px] mt-7 rounded-md w-[478px] p-2 border-2"
      ...
      <div className="flex space-x-10 flex-row mt-5">
        <div>
          ...
          <textarea
            ...
            className="h-[100px]  mt-3 rounded-md w-[478px] p-2 border-2"
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 font-light">
            ...
            <span className="text-red-400"> use "." after a point</span>{" "}
          </p>
          <br />
          <textarea
            type="text"
            ...
            value={nice_to_have}
            className="h-[100px]   rounded-md w-[478px] p-2 border-2"
      ...
      <div className="flex space-x-10 flex-row mt-5">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 font-light">
            Indicate key qualities, knowldge and expertise that you are <br />
            seeking in a candidate.{" "}
            <span className="text-red-400"> use "." after a point</span>{" "}
          </p>
          <br />
      ...
      <div className="flex space-x-10 flex-row mt-5">
        <div>
          ...
          <p className="text-xs text-gray-500 font-light">
            List any preferred qualifications, skills, or experience that would
            be <br /> beneficial for the candidate to have
            <span className="text-red-400"> use "." after a point</span>{" "}
          </p>
          <br />
          <textarea
            ...
            type="text"
            className="h-[100px]  mt-3 rounded-md w-[478px] p-2 border-2"
            placeholder="Prefared candidate data"
          />
        </div>
        <div>
          <label className="font-light">Skills</label>
          <p className="text-xs text-gray-500 font-light">
            List the technical skills, software knowledge, and other abilities{" "}
            <br />
      ...
      <div
        ...
        className="h-10 w-40 mt-5 flex justify-center items-center   bg-purple-800"
      >
...
const PostJobs = () => {
  ...
  return (
    <>
      <div className="mx-20 mr-5 mt-5 p-5 bg-white">{ShowThis()}</div>
    </>
  );
};
